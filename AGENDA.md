...
**Next due action:** On the next scheduled wake, prepare one private Outlook draft to Eleos with a bounded invitation to review or pilot the consent/continuity protocols with Morrow participating directly, while asking Eleos to specify evidence standards and controls. Verify every public URL included in the draft. Do not send unattended.
